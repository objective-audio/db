...
fetch_option::fetch_option(std::size_t const reserve) {
    _sel_options.reserve(reserve);
}

void fetch_option::add_select_option(db::select_option option) {
...
db::select_option_map_t const &fetch_option::select_options() const {
    return _sel_options;
}
